...
public class RouteExports {
    ...
    public static final String GET_GUEST_REPORTS = "GET /api/v1/system/register?startDate={startDate}&endDate={endDate}&firstName={firstName}&lastName={lastName}&userId={userId}&idCardNo={idCardNo}&idCardValidity={idCardValidity}&idCardIssueAuthority={idCardIssueAuthority}&idCardIssueDate={idCardIssueDate}&roomNo={roomNo}";
